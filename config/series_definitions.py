...
SERIES = {
    "B": {
        ...
        "source_policy": "required",     # required | optional
        "target_ratio": 0.18,            # 在总种子池中的目标占比
        "engine_pref": "pubmed",
        "avg_chars": 450,
        "subtopics": [
            "驯化历史", "动物认知", "语言学", "进化生物学",
            "神经科学", "AAC技术", "比较心理学", "人类学", "动物行为",
        ],
        ...
        "notes": "IP 的知识基础层。B1=沟通简史(12张已满)，B2=语言理解研究(4张)，B3+可扩展",
    },
    ...
    "R": {
        ...
        "notes": "数据驱动，支撑商业决策。R1=产品调研，R2=市场分析。信源验证强制开启。",
    },
    ...
    "S": {
        ...
        "forbidden": ["在本文中", "值得注意的是", "综上所述", "根据研究"],
        "source_policy": "optional",
        "target_ratio": 0.15,
        "engine_pref": "web",
        "avg_chars": 500,
        "subtopics": [
            "起源故事", "Bunny叙事", "日常温情", "冒险幻想",
            "幽默反转", "跨物种友谊", "科技反思", "节日主题",
        ],
        ...
        "notes": "IP 的情感核心。S1=篝火旁(6张✅)，S2=Bunny(3张✅)，S3+可扩展新故事线。温度比别的系列高0.05。",
    },
    ...
    "P": {
        ...
        "notes": "品牌故事和人物IP。G系列(视觉)和A系列(多媒体)待后续规划。",
    },
}
